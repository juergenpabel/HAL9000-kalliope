...
SCREENS = {
	...
	"kalliope": {
		"COM": {"src": "COM.jpeg", "tooltip": "Kalliope: Synapses",        "screen": hal9000.console.screen.kalliope.ScreenSynapses()},
		"CNT": {"src": "CNT.jpeg", "tooltip": "Kalliope: Configuration",   "screen": hal9000.console.screen.kalliope.ScreenConfiguration()},
		"MEM": {"src": "MEM.jpeg", "tooltip": "Kalliope: Status",          "screen": hal9000.console.screen.kalliope.ScreenStatus()}
	},
	"enclosure": {
		"VEH": {"src": "VEH.jpeg", "tooltip": "Enclosure: Status",         "screen": hal9000.console.screen.enclosure.ScreenStatus()},
		"ATM": {"src": "ATM.jpeg", "tooltip": "Enclosure: Sensors",        "screen": hal9000.console.screen.enclosure.ScreenSensors()},
		"GDE": {"src": "GDE.jpeg", "tooltip": "Enclosure: Extensions",     "screen": hal9000.console.screen.enclosure.ScreenExtensions()}
	},
	"system": {
		"HIB": {"src": "HIB.jpeg", "tooltip": "System: Hibernation",       "screen": hal9000.console.screen.system.ScreenHibernation()},
		"NUC": {"src": "NUC.jpeg", "tooltip": "System: Power",             "screen": hal9000.console.screen.system.ScreenPower()},
		"LIF": {"src": "LIF.jpeg", "tooltip": "System: Updates",           "screen": hal9000.console.screen.system.ScreenUpdates()},
	},
	"misc": {
		"DMG": {"src": "DMG.jpeg", "tooltip": "Miscellaneous: Logs",       "screen": hal9000.console.screen.misc.ScreenLogs()},
		"FLX": {"src": "FLX.jpeg", "tooltip": "Miscellaneous: Statistics", "screen": hal9000.console.screen.misc.ScreenStatistics()},
		"NAV": {"src": "NAV.jpeg", "tooltip": "Miscellaneous: Help",       "screen": hal9000.console.screen.misc.ScreenHelp()}
	}
}
...
app = flet.app(main, host='127.0.0.1', port=8080, route_url_strategy="path", view=None, assets_dir=f"{os.getcwd()}/assets")
